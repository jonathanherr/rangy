    ...
    rangy.createModule("Highlighter", ["ClassApplier"], function(api, module) {
        ...
        Highlighter.prototype = {
            ...
            serialize: function(options) {
                ...
                forEach(highlights, function(highlight) {
                    ...
                    var parts = [
                        ...
                        highlight.classApplier.elementProperties.style.backgroundColor,
                        highlight.classApplier.elementProperties.style.opacity
                    ];
            ...
            deserialize: function(serialized) {
                ...
                var classApplier, highlight, characterRange, containerElementId, containerElement, backgroundColor, opacity;

                for (var i = serializedHighlights.length, parts; i-- > 0; ) {
                    parts = serializedHighlights[i].split("$");
                    characterRange = new CharacterRange(+parts[0], +parts[1]);
                    containerElementId = parts[4] || null;
                    backgroundColor = parts[5] || null;
                    opacity = parts[6] || null;
                    // Convert to the current Highlighter's type, if different from the serialization type
                    if (convertType) {
                    ...
                    highlight.classApplier.elementProperties.style={}
                    highlight.classApplier.elementProperties.style.backgroundColor=backgroundColor;
                    highlight.classApplier.elementProperties.style.opacity=opacity;
                    highlight.apply();
